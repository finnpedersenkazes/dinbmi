...
var author$project$Main$init = {content: '', height: 0};
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var newHeight = A2(
			...
			0,
			elm$core$String$toFloat(newContent));
		var newHeightValidated = (newHeight < 0) ? 0 : ((newHeight > 250) ? 250 : newHeight);
		var newContentValidated = (!newHeightValidated) ? '' : ((newHeightValidated === 250) ? '' : newContent);
		return _Utils_update(
			model,
			{content: newContentValidated, height: newHeightValidated});
	});
var author$project$Main$colorDanger = {backgroundColor: '#f2dede', borderColor: '#ebccd1', textColor: '#a94442'};
var author$project$Main$colorInfo = {backgroundColor: '#d9edf7', borderColor: '#bce8f1', textColor: '#31708f'};
var author$project$Main$colorInput = {backgroundColor: '#fff', borderColor: author$project$Main$colorInfo.borderColor, textColor: author$project$Main$colorInfo.textColor};
var author$project$Main$colorSuccess = {backgroundColor: '#dff0d8', borderColor: '#d6e9c6', textColor: '#3c763d'};
var author$project$Main$colorWarning = {backgroundColor: '#fcf8e3', borderColor: '#faebcc', textColor: '#8a6d3b'};
...
var author$project$Main$calcWeight = F2(
	function (bmi, model) {
		return A2(
			myrho$elm_round$Round$round,
			0,
			A2(author$project$Main$weightCalculator, bmi, model.height));
	});
...
var author$project$Main$cellStyles = function (color) {
	return _List_fromArray(
		[
...
var author$project$Main$viewTableFirstRow = F4(
	function (title, color, bmi, model) {
		return A2(
			elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
...
var author$project$Main$viewTableInputRow = F2(
...
var author$project$Main$viewTableRow = F5(
	function (title, color, bmi1, bmi2, model) {
		return A2(
			elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
...
var author$project$Main$viewTableBody = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2(author$project$Main$viewTableInputRow, author$project$Main$colorInput, model),
				A4(author$project$Main$viewTableFirstRow, 'Under normal:', author$project$Main$colorInfo, 18.5, model),
				A5(author$project$Main$viewTableRow, 'Normal vægt:', author$project$Main$colorSuccess, 18.5, 25, model),
				A5(author$project$Main$viewTableRow, 'Overvægtig:', author$project$Main$colorWarning, 25, 30, model),
				A5(author$project$Main$viewTableRow, 'Overvægtig fedme klasse 1:', author$project$Main$colorDanger, 30, 35, model),
				A5(author$project$Main$viewTableRow, 'Overvægtig fedme klasse 2:', author$project$Main$colorDanger, 35, 40, model),
				A4(author$project$Main$viewTableLastRow, 'Overvægtig fedme klasse 3:', author$project$Main$colorDanger, 40, model)
			]));
};
var author$project$Main$colorHeader = {backgroundColor: '#eee', borderColor: author$project$Main$colorInfo.borderColor, textColor: author$project$Main$colorInfo.textColor};
